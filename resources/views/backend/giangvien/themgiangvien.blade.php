            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="/themgiangvien" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row" style="margin-bottom:40px">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required type="text" name="hoten" placeholder="Nhập Họ và tên..."
                                            class="form-control">
                                        </div>
                                        <div class="form-group">
                                        <label>Bộ môn</label>
                                        <select class="custom-select my-1 mr-sm-2" name="id_bomon" id="inlineFormCustomSelectPref">
                                            @foreach($bomon as $ch)
                                            <option value="{{$ch->id}}">{{$ch->tenbomon}}</option>
                                            @endforeach
                                        </select>
                                        </div>                                        
                                        <div class="form-group">
                                            <label>Địa chỉ làm việc</label>
                                            <input required type="text" name="diachilamviec" placeholder="Nhập Địa chỉ làm việc..." 
                                            class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Email</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required type="text" name="sdt" placeholder="Nhập Số điện thoại..."
                                            class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Chức vụ</label>
                                            <input required type="text" name="chucvu" placeholder="Nhập chức vụ..."  
                                            class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Website</label>
                                            <input required type="text" name="website" placeholder="Nhập Website..."
                                            class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Môn giảng dạy</label>
                                            <input required type="text" name="mongiangday" placeholder="Nhập Môn giảng dạy..."
                                            class="form-control">
                                        </div>
