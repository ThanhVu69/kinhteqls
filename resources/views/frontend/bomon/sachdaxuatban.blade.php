...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <!-- Title -->
                <h5 class="mt-4" style="color: #9c1010;">SÁCH ĐÃ XUẤT BẢN</h5>
                <small>{{ $sachdaxuatban->tenbomon }}</small>
                <hr>

                <div style="font-size: 13px;">
                <p style="text-align: right;">
                {!! $sachdaxuatban->sachdaxuatban !!}<br><br><br><br><br><br><br><br>
                </p>
            </div> </div>
