                            ...
                            @foreach($bosuutap as $lbst)
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                    <a href="{{ asset('/upload/bosuutap/'.$lbst->hinhanh) }}" data-sub-html="Demo Description">
                                        <img class="img-responsive thumbnail" src="{{ asset('/upload/bosuutap/'.$lbst->hinhanh) }}">
                                    </a>
                                </div>
                            @endforeach
                            </div>
                ...
                <div class="card my-4">
                    <div class="card" style="width: 35rem;">
                        ...
                        @foreach($loaibosuutap as $lbst)
                            <li class="list-group-item"><a style="color: #000" href="{{asset('/bo-suu-tap/'.$lbst->url)}}">{!! $lbst->ten !!}</a></li>
