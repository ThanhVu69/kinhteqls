...
<section class="page-section" id="daotao">
    <div class="container-fluid" style="background-image: url('index/assets/img/nen3.jpg'); background-size: cover;">
        ...
        <br><br>
            <h2 class="section-heading text-uppercase" style="color:#fff">Đào tạo</h2>
        </div>
        <main>
            <div class="container-box">
                ...
                <div class="box box2">
                    ...
                    <h2 style="color: #8e8a8a">Đào tạo đại học</h2>
                    <div class="container-p">
                ...
                <div class="box box3">
                    ...
                    <h2 style="color: #8e8a8a">Đào tạo sau đại học</h2>
                    <div class="container-p">
