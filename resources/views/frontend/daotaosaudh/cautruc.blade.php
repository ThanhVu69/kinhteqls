...
<head>
    ...
    <title>Cấu trúc của chương trình đào tạo</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <!-- Title -->
                <h5 class="mt-4" style="color: #9c1010;">CẤU TRÚC CỦA CHƯƠNG TRÌNH ĐÀO TẠO THẠC SỸ</h5>
                <hr>
                <div style="font-size: 13px;">
                <p style="text-align: right;">@foreach($daotaothacsy as $mh)
                    {!! $mh->cautruc !!}<br><br><br><br><br><br><br><br>
                    @endforeach</p>
            </div></div>
