...
<head>
    ...
    <title>Danh sách nghiên cứu sinh và đề tài nghiên cứu</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <!-- Title -->
                <h5 style="color: #9c1010;" class="mt-4">Danh sách nghiên cứu sinh và đề tài nghiên cứu</h5>
                <hr>
                <!-- Post Content -->
                <div style="font-size: 13px;">
                <p style="text-align: right;">@foreach($daotaosaudh as $mh)
                        {!! $mh->danhsachnghiencuusinh !!}
                        @endforeach</p>
                        </div>
            </div>
