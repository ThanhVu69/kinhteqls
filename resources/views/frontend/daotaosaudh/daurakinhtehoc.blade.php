...
<head>
    ...
    <title>Chuẩn đầu ra của Chương trình tiến sỹ Kinh tế học</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <!-- Title -->
                <h5 class="mt-4" style="color: #9c1010;">CHUẨN ĐẦU RA CHƯƠNG TRÌNH TIẾN SỸ KINH TẾ HỌC</h5>
                <hr>

                <div style="font-size: 13px;">
                <p style="text-align: right;">@foreach($daotaotiensy as $mh)
                        {!! $mh->daurakinhtehoc !!}<br><br><br><br><br><br><br><br>
                        @endforeach</p>
            </div> </div>
