...
<head>
    ...
    <title>Chương trình tiến sỹ Quản lý công nghiệp</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <!-- Title -->
                <h5 class="mt-4" style="color: #9c1010;">CHƯƠNG TRÌNH TIẾN SỸ QUẢN LÝ CÔNG NGHIỆP</h5>
                <hr>

                <div style="font-size: 13px;">
                <p style="text-align: right;">@foreach($daotaotiensy as $mh)
                        {!! $mh->quanlycongnghiep !!}<br><br><br><br><br><br><br><br>
                        @endforeach</p>
            </div> </div>
